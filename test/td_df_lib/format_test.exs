defmodule TdDfLib.FormatTest do
  ...
  describe "search_values/2 markdown type strips markdown for search" do
    test "markdown field value is stripped of heading syntax in search values" do
      content = %{
        "md_field" => %{"value" => "## My Markdown", "origin" => "user"}
      }
      ...
      fields = [
        %{
          "name" => "group",
          "fields" => [
            %{"name" => "md_field", "type" => "markdown", "cardinality" => "?"}
          ]
        }
      ]

      result = Format.search_values(content, %{content: fields})
    ...
    test "search_values/2 strips links, headings, bold and inline code from markdown fields" do
      content = %{
        "notes" => %{
          "value" => "# Hello\nVisit [link](https://example.com) and **bold** `code`",
          "origin" => "user"
        }
      }
      ...
      fields = [
        %{
          "name" => "group",
          "fields" => [
            %{"name" => "notes", "type" => "markdown", "cardinality" => "?"}
          ]
        }
      ]
      ...
      assert Format.search_values(content, %{content: fields}) == %{
               "notes" => %{
                 "value" => "Hello Visit link and bold ",
                 "origin" => "user"
               }
             }
    end

    test "search_values/2 removes newline characters from markdown fields" do
      content = %{
        "md_field" => %{
          "value" => "paragraph one\n\nparagraph two",
          "origin" => "user"
      ...
      assert Format.search_values(content, %{content: fields}) == %{
               "md_field" => %{
                 "value" => "paragraph one  paragraph two",
                 "origin" => "user"
               }
             }
    end
