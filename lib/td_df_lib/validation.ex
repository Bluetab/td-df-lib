defmodule TdDfLib.Validation do
  ...
  @role_based_types ~w(user group user_group)
  ...
  defp add_date_restrictions_validation(
    ...
    # Skip validation when editing an entity if this field hasn't changed.
    # Per spec: "if the field is not changed, no validation is required".
  ...
  # Legacy flat schema: {"between_start" => "...", "between_end" => "..."}
  ...
  # New nested schema: {"between" => %{ "mode" => "static", "start" => "...", "end" => "..." }}
  defp maybe_check_between(
         changeset,
         name,
         value,
  ...
  # New nested schema (dynamic): both sides relative to today.
  defp maybe_check_between(
         changeset,
         name,
         value,
  ...
  # Shift a Date by the given options using Timex. Negative values move backwards.
  defp shift_date(date, opts) do
    Timex.shift(date, opts)
  end

  # Shift a NaiveDateTime by the given options using Timex. Time-of-day is preserved.
